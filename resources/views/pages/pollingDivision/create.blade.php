...
<div class="heading flex justify-between text-xl px-2 py-2 border-b-2 border-gray-300">
  <div class="">
    <span class="text-gray-900">Create New Polling Division for <span class="font-semibold">{{ $district->name }}</span> district</span>
...
<form class="mx-auto w-full max-w-lg mx-8 my-8 px-4 py-4 bg-white shadow-lg rounded-lg" method="post" action="{{ route('pollingDivision.store') }}">
  @csrf
