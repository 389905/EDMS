...
<div class="heading flex justify-between text-xl px-2 py-2 border-b-2 border-gray-300">
  <div class="">
    <span class="text-gray-900">Create New Grama Niladhari Division for {{ $divSec->name }}</span>
...
<form class="mx-auto w-full max-w-lg mx-8 my-8 px-4 py-4 bg-white shadow-lg rounded-lg" method="post" action="{{ route('gndivision.store') }}">
  @csrf
  ...
  <input type="hidden" name="divSec_id" value="{{ $divSec->id }}">
